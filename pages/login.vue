...
const form = ref({ email: "", password: "" , contact: "", username: ""});
  ...
  <div name="root">
    ...
    <div class="v50_71">
      ...
      <div
        class="inline-block"
        name="form_container"
        style="position: absolute; top: 185px; left: 1126px"
      >
...
.v50_80 {
  width: 639px;
  height: 791px;
  background: url("../images/v50_80.png");
  background-repeat: no-repeat;
  background-position: center center;
  background-size: cover;
  opacity: 1;
...
.v50_81 {
  width: 639px;
  height: 791px;
  background: url("../images/v50_81.png");
  background-repeat: no-repeat;
  background-position: center center;
  background-size: cover;
  opacity: 1;
...
.v50_85 {
  width: 540px;
  height: 464px;
  background: url("../images/v50_85.png");
  background-repeat: no-repeat;
  background-position: center center;
  background-size: cover;
  opacity: 1;
...
.v50_88 {
  width: 481px;
  height: 117px;
  background: url("../images/v50_88.png");
  background-repeat: no-repeat;
  background-position: center center;
  background-size: cover;
  opacity: 1;
